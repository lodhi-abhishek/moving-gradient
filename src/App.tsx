...
export default function App() {
  ...
  return (
    <main className='flex min-h-[100dvh] w-full items-center justify-center'>
      <div
        ref={wrapperRef}
        className='relative mx-auto aspect-[9/16] w-[360px] max-w-full overflow-hidden rounded-2xl bg-gradient-to-br from-[var(--color-a)] via-[var(--color-b)] to-[var(--color-c)] p-8 text-white duration-500 ease-in [transition-property:_--color-a,_--color-b,_--color-c] before:absolute before:left-[20%] before:top-[10%] before:h-[50%] before:w-[70%] before:origin-[60%] before:animate-blob before:rounded-3xl before:bg-gradient-to-br before:from-[var(--color-a)] before:to-[var(--color-b)] before:blur-[50px] before:brightness-125 after:absolute after:left-[40%] after:top-[30%] after:h-[80%] after:w-[70%] after:origin-[60%] after:animate-blob-reverse after:rounded-3xl after:bg-gradient-to-br after:from-[var(--color-a)] after:to-[var(--color-b)] after:blur-[50px] after:brightness-125'
      >
